 ...
 */
public class ViewCustomerFeedback extends javax.swing.JFrame {

    /**
     * Creates new form ViewCustomerFeedback
     */
    public ViewCustomerFeedback() {
        ...
        {
            conn c= new conn();
            String str = "select o.Cust_Aadhar_ID,c.Cust_Name,o.Room_No,o.Check_In,o.Check_Out,o.feedback from occupies o, customer c where o.Cust_Aadhar_ID = c.Cust_Aadhar_ID and (o.feedback is not NULL)";
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Aadhar ID", "Customer Name", "Room ", "Check In", "Check Out", "Feedback"
            }
        ) {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(2).setMaxWidth(8);
            jTable1.getColumnModel().getColumn(3).setPreferredWidth(13);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCustomerFeedback.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
